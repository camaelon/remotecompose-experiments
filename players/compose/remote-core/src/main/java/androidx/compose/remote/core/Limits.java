 ...
 *
 * Local desktop-player fork: MAX_EXPRESSION_SIZE raised from 32 to 256 so documents
 * containing longer float expressions (e.g. complex spline/interpolation curves in some
 * Examples slides) can load. The file is served by the Sync task in
 * remote-core/build.gradle.kts, which excludes the upstream copy.
 */
...
public class Limits {
    ...
    public static final int MAX_EXPRESSION_SIZE = 256;
